...
export const managers = [
    ...
    },
    {
      ...
      "name": "Kyle Pottorf",
      "location": "Columbus", // (optional)
      "bio": `<p>No team has been a better epitome for incredibly consistent irrelevance than my OFODL dynasty team. Consistently finishes between from 6-11 have been the norm for my team's troubled past. All of that changes this year…</p>
      <p>Having a team built on young unproven running backs and poorly times trading of studs set my squad back multiple years. With Cam Akers torn achilles, JK Dobbins torn ACL, Javonte Williams torn ACL and one of the worst trades of the past couple years (sending Amon Ra and Saquon after the 2021 season for Dobbins and the hobbit himself - Rondale Moore).</p>
      <p>However…the stars have aligned for a possible darkhorse championship run for “Fields of Dreams”. Led by breakout star QB Justin Fields, a strong core of running back breakout candidates, and the everlasting DK Metcalf shine light on a brighter future that lies ahead. One with sunshine, rainbows, hail marys, long TD's and the hope of a long awaited fantasy football title. As the great Yoda once said, “Do or do not. There is no try.” The “Fields of Dream” plan to DO…and DO it good we shall.</p>
      `,
      "photo": "self", // square ratio recommended (no larger than 500x500)
      "fantasyStart": 2014, // (optional) when did the manager start playing fantasy football
      "favoriteTeam": "cle", // (optional) favorite NFL team, (follows convention: nyj, sea, mia, etc.) MUST BE LOWERCASE
